...
const Auth = () => {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center py-8 px-4">
        <div className="fixed inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[radial-gradient(circle,hsl(var(--accent)/0.06),transparent_70%)]" />
        </div>

        <Card className="w-full max-w-md shadow-form relative z-10 border-border/50 animate-scale-in">
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center py-8 px-4">
      ...
      <Card className="w-full max-w-md shadow-form relative z-10 border-border/50 animate-fade-in-up" style={{ animationDelay: "0.05s", opacity: 0 }}>
        ...
        <CardContent className="space-y-5">
          ...
          <Button
            variant="outline"
            className="w-full flex items-center justify-center gap-3 h-12 font-semibold text-base hover:bg-secondary hover:border-primary/30 transition-all duration-200"
